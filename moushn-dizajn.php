...
while (have_posts()) : the_post(); ?>
   ...
   <?php
   $zzz = new WP_Query('post_type=hot&category_name=moushn-dizajn');
   if ($zzz->have_posts()) { ?>
      <section id="hot" class="hot">
         <div class="container">
            ...
            <div class="wrapper">
               ...
               <?php
               $pc = new WP_Query('post_type=hot&category_name=moushn-dizajn'); ?>
   ...
   <?php
   $qqq = new WP_Query('post_type=portfolio&category_name=moushn-dizajn');
   if ($qqq->have_posts()) { ?>
         ...
         <div class="container">
            ...
            <div class="slider02 swiper-container">
               <div class="swiper-wrapper">
                  <?php
                  $pc = new WP_Query('post_type=portfolio&category_name=moushn-dizajn'); ?>
                  <?php while ($pc->have_posts()) : $pc->the_post(); ?>
