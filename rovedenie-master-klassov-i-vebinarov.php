...
while (have_posts()) : the_post(); ?>
   ...
   <?php
   $zzz = new WP_Query('post_type=hot&category_name=rovedenie-master-klassov-i-vebinarov');
   if ($zzz->have_posts()) { ?>
      <section id="hot" class="hot">
         <div class="container">
            ...
            <div class="wrapper">
               ...
               <?php
               $pc = new WP_Query('post_type=hot&category_name=rovedenie-master-klassov-i-vebinarov'); ?>
   ...
   <?php
   $qqq = new WP_Query('post_type=portfolio&category_name=rovedenie-master-klassov-i-vebinarov');
   if ($qqq->have_posts()) { ?>
